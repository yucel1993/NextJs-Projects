...
export default function Profile({params}:ProfilePageTypes){
    ...
    return(
        ...
        <ClientOnly>
            {true ? (
                <img className="w-[120px] min-w-[120px] rounded-full" src={currentProfile?.image} alt="user" />
            ) : (
             <div
             className="min-w-[150px] h-[120px] bg-gray-200 rounded-full"
             >
                ...
                <ClientOnly>
                    <p className="pt-4 mr-4 text-gray-500 font-light text-[15px] pl-1.5 max-w-[500px]"></p>
                            {currentProfile?.bio}
