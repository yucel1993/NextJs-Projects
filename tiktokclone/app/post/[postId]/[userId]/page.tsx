    ...
    return(
        ...
        >
            ...
            <div>
                ...
                className="absolute z-20 right-4 top-4 flex items-center justify-center rounded-full bg-gray-700 hover:bg-gray-800"
                > 
                ...
                className="absolute z-20 right-4 top-20 flex items-center justify-center rounded-full bg-gray-700 hover:bg-gray-800"
                > 
            ...
            <div 
            className="bg-black bg-opacity-70 lg:min-w-[480px] z-10 relative"
            >
            {postById?.video_url ? (
                <video 
                src="/video1.mp4"
