    ...
    return (
        ...
        <UploadLayout>
            ...
            {!fileDisplay ? (
                ...
                >
                 ...
                 <p className="mt-1.5 text-gray-500 text-[13px]">Or Drag and drop the file</p>
                ...
                alt="mobile"
                className="absolute z-20 bottom-6 right-4"
                ...
                />
                    ...
                    <p
                    className="text-[11px] pl-1 truncate text-ellipsis"
                    >{file ? file.name : ""}</p>
                    </div>
                    <button 
                    onClick={()=>clearVideo()}
        ...
        <div className="mt-4 mb-6">
                    ...
                    <div>
                            ...
                            <div className="text-semibold text-[13px] text-gray-400">
                              You can quickly divide videos into multiple 
                                   parts,remove redundant parts and turn landescape videos into potrait videos
                             </div>
                    </div>
            ...
            <div className="flex gap-3">
                    ...
                    >
                       {isUploading ? <BiLoaderCircle classNmae="animate-spin" color="#ffffff"  size="25" /> : "Post"}    
                    </button>
            </div>
            {error ? ( 
